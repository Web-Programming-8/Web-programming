const places = {
  휴식지: [
    ...
    { name: "횡성 미술관 자작나무숲", image: "/static/images/random/hoengseong-rd.jpg" },
  ],
  액티비티: [
  ...
  신상여행지: [
    { name: "창원 마산로봇랜드", image: "/static/images/random/changwon-rd.jpg" },
    { name: "서울 젠틀몬스터 하우스도산", image: "/static/images/random/seoulj-rd.jpg" },
    { name: "통영 욕지섬모노레일", image: "/static/images/random/tongyeongsum-rd.jpg" },
