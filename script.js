document.addEventListener('DOMContentLoaded', function () {
    ...
    console.log('Elements initialized:', { searchNav, regionInfoNav, searchArea, mapContainer });
    ...
    function changeBackground() {
        ...
        const activeBackground = backgroundContainer.querySelector('.background-image.active');
        if (activeBackground) {
